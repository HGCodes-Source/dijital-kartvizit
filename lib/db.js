...
function toRow(obj) {
  ...
  if (obj.viewCount !== undefined) row.view_count = obj.viewCount;
...
// Kartvizit sayfasi her acildiginda goruntulenme sayacini bir artirir.
// Postgres fonksiyonu (increment_view_count) uzerinden atomik yapilir,
// boylece ayni anda birden fazla ziyaretci olsa bile sayim kaymaz.
